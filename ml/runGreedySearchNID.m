...
PEN1=[0.005 0.25;0.005 0.25 ;0.005 0.25 ;0.005 0.25; 0.005 0.25; 0.005 0.5;0.25 0.6];
p= 0.1;
...
resultname = [outdir,'/','dim8-PEN1-quan0.1result-mesh0.02-for-node', num2str(nodeID) '.mat' ];
